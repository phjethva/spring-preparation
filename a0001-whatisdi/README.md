### A0001 - What is DI (Dependency Injection)?
...
- The `ApplicationContex` is a complete superset of the BeanFactory and is used exclusively in this chapter in descriptions of Spring’s IoC container.
